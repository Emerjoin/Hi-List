package org.emerjoin.hi.web.component;
...
public class HiList {
    ...
    public static Map listEncode(Collection data, int matches, int page, int itemsPerPage) throws IllegalArgumentException{
        ...
        return listEncode(array,matches,page,itemsPerPage);
